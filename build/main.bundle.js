...
var go = function go(name, abv) {
    ...
    fetch(url).then(function (response) {
        ...
        for (var i = 0; i < beers.length; i++) {
            result += "<image src =" + beers[i].image_url + " style ='width:60px' />" + "<br> <b>Name : </b>" + beers[i].name + "<br> <b>Alcohol by volume : </b>" + beers[i].abv + "<br> <b>Description : </b>" + beers[i].description + "<hr>";
        }
        document.getElementById('result').innerHTML = result;
    });
};
